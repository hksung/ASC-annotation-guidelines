...
Intransitive verbs (e.g., *stay*, *remain*, *live*) often require an obligatory advervial argument, which typically answers a question like 'Where is/was X'? (Biber et al., 1999, pp. 141-145). We will treat these patterns similarly to copular verbs (e.g., *I am in a room*), thus assigning the ATTR tag. The following are some example sentences.
```
- I live in Okinawa.
- Three bomb victims were still in St Bartholomev's Hospital last night.
- The baby was lying on his back.
- He remained in the hospital for few days.
```
